...
import { TEXT_META, WRAP } from "@/lib/redesign/ui";
...
export function FooterV3() {
  ...
  return (
    ...
    <footer
      ...
      data-nav-dark
      className="bg-noir py-[clamp(40px,5vw,64px)] text-white/60"
      aria-label="Footer"
    >
      ...
      <div className={`${WRAP} flex flex-col gap-10 lap:flex-row lap:items-start lap:justify-between`}>
        <div className="flex max-w-[288px] flex-col items-start gap-8">
          <div className="flex flex-col items-start gap-4">
            ...
            {/* The same wordmark the nav carries, so the page has one identity
                rather than a second mark invented for the footer. */}
            <a href="#top" className="inline-flex items-center" aria-label={`${brand} home`}>
              <img src="/ls-icon.png" alt="" className="-ml-2.5 h-9 w-[118px] object-contain object-left" />
            </a>
          ...
          <div className="flex flex-col items-start gap-1">
            ...
            <p className={`font-sans ${TEXT_META} text-white/40`}>
