...
/* THE CLAIM CARD'S GROUND — /bg.png, with the two brand tints washed over it.
   ...
   There is no way to flip ONE layer of a background-image list — a transform
   would turn the element and everything in it, and moving the photograph to a
   pseudo-element to flip it there would put it ABOVE the two radials instead of
   under them, which is the one thing the order note below exists to prevent.
   So public/bg.png is stored flopped. It was re-encoded losslessly on the way
   through (verified pixel-for-pixel against the flopped source) and came out
   25% smaller than it was, 6.9MB to 5.1MB.
   ...
   cover/center/no-repeat RATHER THAN THE NATURAL SIZE. The source is 2752x1536
