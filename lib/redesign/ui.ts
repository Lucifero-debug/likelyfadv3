...
export const SECTION = "py-[clamp(64px,8vw,128px)]";

/* THE SECTION HEADING, AS ONE STRING. Big, extra-bold and tight: past the hero
   the headings are the page's main visual device, so they are set as display
   type rather than as labels over the content. 40px on a phone, 76px at the
   top — always a step under the hero headline. text-balance keeps a two-line heading from ending on one word. */
export const HEADING =
  "text-balance font-display text-[clamp(2.5rem,1.1rem+3.6vw,4.75rem)] font-extrabold leading-[0.95] tracking-[-0.04em]";
...
export const TEXT_H1 =
  ...
  "lap:text-[clamp(2.6rem,0.4rem+5.2vw,6.25rem)]";
